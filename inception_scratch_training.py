...
def train_alone_model(base_model, epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        outputs = base_model(inputs.float())
...
if __name__ == '__main__':
    ...
    if args.output_directory is None:
        args.output_directory = f'/results_inception/scratch_training_1e-5_weights_1_1_1_epochs_1500/'
    ...
    for dataset in args.datasets:        
        for seed in new_seeds:
            ...
            pruned_model = torch.load(os.getcwd() + f'/results_inception/base_models_1e-5_weights_4_2_1/ins_sparse_seed_{seed}/{dataset}/pruned_model.pth',)
