...
if __name__ == '__main__':
    ...
    if args.output_directory is None:
        args.output_directory = f'/results/base_models_20_filters/'
    ...
    for dataset in args.datasets:        
        for seed in new_seeds:
            ...
            set_seeds(seed)
            base_model = LITE(output_directory=None, length_TS=length_TS, n_classes=len(np.unique(ytrain)), n_filters=[[20, 20, 20], 20, 20])
            ...
            best_model = LITE(output_directory=None, length_TS=length_TS, n_classes=len(np.unique(ytrain)), n_filters=[[20, 20, 20], 20, 20])
