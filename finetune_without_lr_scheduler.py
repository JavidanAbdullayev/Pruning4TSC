...
if __name__ == '__main__':
    ...
    if args.output_directory is None:
        args.output_directory = f'/results/finetune_1e-5_weights_4_2_1_without_lr_scheduler/'
    ...
    for dataset in args.datasets:        
        for seed in new_seeds:
            ...
            set_seeds(seed)
            pruned_model = torch.load(os.getcwd() + f'/results/base_models_1e-5_weights_4_2_1/ins_sparse_seed_{seed}/{dataset}/pruned_model.pth',)
            ...
            df = pd.DataFrame(list(zip(training_loss)), columns =['loss',])
