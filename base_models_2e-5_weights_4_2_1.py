...
from utils import load_data, preprocess_data, create_directory, plot_loss_and_acc_curves, InstanceFeatureSparseLoss
...
def get_args():
    ...
    dataset_names = [ 
                    ...
                    #  'ArrowHead', 'BeetleFly', 'BirdChicken', 'Beef',  'BME', 'Car', 'CBF', 
...
def train_alone_model(base_model, epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        loss= criterion_CE(outputs, targets) + \
              ins_sparse_loss(features[0][:96]) * 4 + ins_sparse_loss(features[1]) * 2 + ins_sparse_loss(features[2])
...
if __name__ == '__main__':
    ...
    if args.output_directory is None:
        args.output_directory = f'/results/base_models_2e-5_weights_4_2_1/'
    ...
    for dataset in args.datasets:        
        for seed in new_seeds:
            ...
            ins_sparse_loss = InstanceFeatureSparseLoss(lambda_reg=1e-5 * 2)
